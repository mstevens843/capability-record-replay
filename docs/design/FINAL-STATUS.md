...
> `pnpm demo` produced **278 files** with a clean whole-bundle canary.
...
### 7.1 The fixture is our own construction, and that is the main threat to every reliability number here
